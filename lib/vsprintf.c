...
static char *mac_address_string(char *buf, uint8_t *addr, int field_width,
...
static char *ip6_addr_string(char *buf, uint8_t *addr, int field_width,
			 int precision, int flags)
{
...
static char *ip4_addr_string(char *buf, uint8_t *addr, int field_width,
			 int precision, int flags)
{
...
int __attribute__((weak, alias("vsprintf")))
    __wrap_vsprintf(char *buf, const char *fmt, va_list args);
/**
